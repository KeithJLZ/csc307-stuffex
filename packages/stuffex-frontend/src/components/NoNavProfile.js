/**
 * Copy of the Profile component with the exception that it does not contain
 * a useNavigation hook. This is necessary in order to run the component in a
 * testing environment with no real router.
 */
...
function Profile(props) {
  ...
  function createProf() {
    const profErrors = validateProf(user)
  ...
  return (
    <form>
      ...
      <input id="submitButton" type="button" value="Create Profile" onClick={createProf} />
        &#60;- Back{' '}
    </form>
  )
}
